...
Function colored_contrast_text(bgColor As Variant, _
                               Optional as_color As Boolean = True, _
                               Optional light_limit As Double = 90, _
                               Optional dark_limit As Double = 15)
    ...
    ' THIS REQUIRES colorfuncs v1.0.1 or above
    ...
    colored_contrast_text = rgb_to_long(new_rgb)
End Function
...
Private Sub color_cells_with_scheme()
    ...
    With Selection
        ...
        .Font.Color = colored_contrast_text(primary_color)
        .Font.Bold = False
        With .Offset(0, 1)
            .Interior.Color = secondary_color
            .Font.Color = colored_contrast_text(.Interior.Color)
        End With
        With .Offset(0, 2)
